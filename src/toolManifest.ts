...
export const PUBLIC_SEARCH_TOOL_NAME = "search_paper_evidence";
...
export const checkClaimDescription =
  "건강·의학·약·음식·영양·운동·수면·육아·심리 질문의 근거 논문을 검색하고 한국어로 답하는 카더라 말고(Kadera) 도구입니다. '크레아틴이 탈모를 일으키나요?', '마운자로 부작용은?', '간헐적 단식 효과 있어?', '계란 하루 두 개 괜찮아?'처럼 논문을 언급하지 않은 일반 질문에도 사용하세요. 모델 지식으로 답하기 전에 이 도구로 실제 논문을 확인해야 합니다. '이거 진짜야?', '카더라 말고로 확인해줘', '논문 찾아줘', '연구를 확인해줘'도 호출 대상입니다. 질문은 한국어 그대로 question에 넣으세요. 결과는 [1234-a] 형식의 논문 키와 완성 답변인 한국어 Markdown을 반환하므로 섹션·표·논문 키·링크를 빠뜨리지 말고 그대로 전달하세요. 개인정보·진료기록, 일상 대화, 창작, 쇼핑에는 사용하지 않습니다.";
